...
df = df_ADF.iloc[:, 1:3]
ax = df.plot.bar(axes=axes)

from pandas_profiling import ProfileReport
profile = ProfileReport(factor_test, title='MPG Pandas Profiling Report')
profile.to_file('report.html')


import sweetviz as sv
my_report = sv.analyze(factor_test)
...
get_var_no_colinear(0.7, factor_test)
